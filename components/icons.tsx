...
export const Redo2Icon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M19.5 9H9.5a8.5 8.5 0 1 0 0 17H13" />
  </svg>
);
...
export const Wand2Icon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M9 4.5v3m3-3v3m-3 9v3m3-3v3m-6-6h3m3 0h3m-9 3h3m3 0h3m-6-6 1.5-1.5M15 4.5l1.5-1.5M4.5 9l-1.5 1.5M4.5 15l-1.5 1.5m15-1.5 1.5-1.5M19.5 9l1.5 1.5" />
  </svg>
);
...
export const PaletteIcon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.668 0-.92-.742-1.667-1.648-1.667-.926 0-1.648-.74-1.648-1.66-0-.924.722-1.67 1.648-1.67.926 0 1.648-.746 1.648-1.667 0-.92-.742-1.666-1.648-1.666a1.668 1.668 0 0 0-1.648-1.67c0-.924.722-1.666 1.648-1.666.926 0 1.648-.746 1.648-1.667 0-.92-.742-1.667-1.648-1.667A10.07 10.07 0 0 0 12 2z" />
    </svg>
);
...
export const PlayIcon = ({ fill = "none", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    ...
    strokeLinejoin="round"
  >
    <polygon points="5 3 19 12 5 21 5 3" fill={fill} />
  </svg>
);
